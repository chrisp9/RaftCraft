...
type RaftSystem() = 
    static member Create
        ...
        let electionTimerFactory = fun() -> ElectionTimer(timerHolder, int64 300)
        ...
        let peerSupervisorFactory = fun v -> new PeerSupervisor(configuration, v, fun v -> new PeerDiplomat(translatedClientFactory(v), 100, timerHolder))
